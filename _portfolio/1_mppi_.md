...
excerpt: "Implemented MPPI on an RC car platform using C++ and ROS to enable aggressive driving. <br/><img src='/images/mppi_paths.png'>"
...
* <b>In-Depth</b>
    ...
    * <p style="text-align: justify;"><b>MPPI vs iLQR/FALCO</b><br>This section will give a brief comparison of iLQR/FALCO and our MPPI implementation.</p>
    ...
    <div style="text-align:center">
    <img src="/images/falco_paths.png" alt="falco_paths" style="width:600px;height:300px;">
    </div>
    ...
    <div style="text-align:center">
    <img src="/images/mppi_paths.png" alt="mppi_paths" style="width:600px;height:300px;">
    </div>
