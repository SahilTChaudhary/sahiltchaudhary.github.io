...
excerpt: "Implemented MPPI on an RC car platform using C++ and ROS to enable aggressive driving. 
![MPPI](/images/mppi_paths.png){:width='250px' height='150px'}" 
